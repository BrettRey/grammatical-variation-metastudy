...
Note that JSlx has zero observations for order variables. This implies that any model estimates regarding order variables in JSlx are extrapolations from the prior and the LVC data, rather than identifying information from JSlx itself. Consequently, the variation-type effects are largely estimated from within-LVC comparisons.
