...
Type: Realization (vs. Order) & 2.33 & [1.12, 4.89] \\
Year (per SD $\approx$ 9.6 years) & 1.65 & [1.04, 2.67] \\
\bottomrule
\end{tabular}
\end{table}

Testing varies notably by journal, variation type, and year. First, LVC is less likely to test variables than JSlx. In plain terms, variables in LVC have about one-third the odds of being tested for social significance compared to JSlx. Second, realization variables are more likely to be tested than order variables, with more than twice the odds of being tested. Finally, testing increases over time; for each decade, testing odds increase by about 65\%.
