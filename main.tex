...
The model's selection estimates converge with their descriptive findings. In this dataset, among production studies, LVC finds social significance at 92\% (155/169) compared to JSlx at 83\% (87/105). This difference ($\chi^2=4.93$, $p=.026$) supports their argument that LVC's lack of a social-significance framing requirement doesn't inflate publication bias~-- researchers who look for effects overwhelmingly find them.
