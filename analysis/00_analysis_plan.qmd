...
- Fixed effects (standardized predictors): $\beta \sim \text{Normal}(0, 0.7)$ on log-odds scale
- Intercepts: $\alpha \sim \text{Normal}(0, 1.2)$
- Varying intercept SDs: $\sigma_u \sim \text{Exponential}(2)$
